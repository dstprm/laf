...
const cards = [
  {
    title: 'Storage used',
    icon: <Bolt className={'text-ui-icon'} size={18} />,
    value: '1.2 GB',
    change: '10 GB remaining',
  },
  {
    title: 'Active workspaces',
    icon: <Shapes className={'text-ui-icon'} size={18} />,
    value: '4',
  ...
  },
  {
    ...
    icon: <Image className={'text-ui-icon'} size={18} />,
    value: '286',
    change: '+16% from last month',
  },
  {
    title: 'Collaborators',
    icon: <Timer className={'text-ui-icon'} size={18} />,
    value: '10',

...
/**
 * Fetches localized display prices for all plan price IDs defined in `PricingTier`.
 *
 * Notes:
 * - This is for displaying sticker prices on cards; it does NOT reflect proration for mid-cycle changes.
 * - For proration estimates on plan changes, see `previewPlanChange` in server actions.
 */
